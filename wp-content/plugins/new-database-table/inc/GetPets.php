...
class GetPets
{
    ...
    function __construct()
    {
        ...
        // $ourQuery = $wpdb->prepare("SELECT * from $tablename WHERE species = %s LIMIT 100", array($_GET['species'])); // To use variables on these queries, you need double quotes
        $this->args = $this->getArgs();
        // $this->placeholders = $this->createPlaceholders(); // This is no longer needed
